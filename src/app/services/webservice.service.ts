...
export class WebserviceService {
    ...
    // apiHead = "http://172.30.1.22:8080"
    apiHead = "http://139.59.73.239:8080"
    ...
    listDataGet(urlValue,submitData){
        return new Promise((resolve,reject)=>{
          this.method(urlValue, submitData, 'get')
          .subscribe(list => {
            resolve(list)
          },Error=>{
            console.log(Error);
            reject("Error in call")
          })
    ...
    listDataFetch(urlValue,submitData){
        return new Promise((resolve,reject)=>{
          this.method(urlValue, submitData, 'post')
          .subscribe(list => {
            resolve(list)
          },Error=>{
            console.log(Error);
      ...
      listDataFetchJson(urlValue,submitData){
        return new Promise((resolve,reject)=>{
          this.method(urlValue, submitData, 'postjson')
          .subscribe(list => {
            resolve(list)
          },Error=>{
            console.log(Error);
